...
{:else}
  <main
    ...
    style="--isLoaded: {isImageLoaded ? 1 : 0}"
  >
    <div
      class="m-2 h-14 w-14 drop-shadow-xl rounded-full fixed top-0 right-0 avatar"
    >
      <img
        class="rounded-full"
      ...
      <div
        id="login-indicator"
        class="bg-red-500 absolute top-0 right-0 w-4 h-4 rounded-full"
      />
    </div>
